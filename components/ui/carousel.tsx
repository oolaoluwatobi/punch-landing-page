...
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  const { orientation, marketPlace, scrollPrev, canScrollPrev } = useCarousel();
  ...
  return (
    <Button
      ...
      className={cn(
        ...
        marketPlace && !canScrollPrev ? "hidden" : "",
        orientation === "horizontal"
...
const CarouselNext = React.forwardRef<
  ...
  React.ComponentProps<typeof Button>
>(({ className, variant = "outline", size = "icon", ...props }, ref) => {
  const { orientation, marketPlace, scrollNext, canScrollNext } = useCarousel();
  ...
  return (
    <Button
      ...
      className={cn(
        "absolute h-8 w-8 rounded-full",
        marketPlace && !canScrollNext ? "hidden " : "",
        orientation === "horizontal"
